...
Запуск и демо: [`../fast_start/ЗАПУСК_WINDOWS.md`](../fast_start/ЗАПУСК_WINDOWS.md) · [`../fast_start/ЗАПУСК_DOCKER.md`](../fast_start/ЗАПУСК_DOCKER.md) · [`../fast_start/DEMO_GUIDE.ru.md`](../fast_start/DEMO_GUIDE.ru.md)

Архитектура кода: [`../ARCHITECTURE.ru.md`](../ARCHITECTURE.ru.md)
